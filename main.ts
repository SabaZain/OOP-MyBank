...
console.log(chalk.blue.bold("Welcome to Code With Saba - Object Oriented Programming MyBank"));
console.log(chalk.yellow.bold("-".repeat(62)));
...
const userAccounts: BankAccount[] = [
    new BankAccount(1414, 1000),
    new BankAccount(1415, 2000),
    new BankAccount(1416, 2500),
]

// Create CustomerS
const Customers: Customer[] = [
    new Customer ("Ali","Ahmed","Male", 30 , 3332457330, userAccounts[0]),
    new Customer ("Sana","Fahad","Female", 25 , 3102457350, userAccounts[1]),
    new Customer ("Sofia","Ali","Female", 32 , 3312458130, userAccounts[2]),
]
